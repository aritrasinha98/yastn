...
def ctm_env_real_time_c_up(lattice, boundary, purification, xx, yy, D, sym, chi, interval, beta_end, beta_start, U, mu_up, mu_dn, t_up, t_dn, step, tr_mode, fix_bd):
    ...
    file_name = "c_dn_shape_%s_Nx_%1.0f_Ny_%1.0f_boundary_%s_purification_%s_fixed_bd_%1.1f_%s_%s_Ds_%s_U_%1.2f_MU_UP_%1.5f_MU_DN_%1.5f_T_UP_%1.2f_T_DN_%1.2f_%s" % (lattice, dims[1], dims[0], boundary, purification, fix_bd, tr_mode, step, D, U, mu_up, mu_dn, t_up, t_dn, sym)
