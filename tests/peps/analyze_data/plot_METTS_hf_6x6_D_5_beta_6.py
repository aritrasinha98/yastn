...
nsm = 17
avg_energy = (1/3)*running_average(data1[0:nsm,1]+data2[0:nsm,1]+data5[0:nsm,1])
avg_do = (1/3)*running_average(data1[0:nsm,2]+data2[0:nsm,2]+data5[0:nsm,2])
...
#ax[0].plot(sample_3_energy[0:nsm], label=r'sample 3, D=4')
#ax[0].plot(sample_4_energy[0:nsm], label=r'sample 4, D=4')
