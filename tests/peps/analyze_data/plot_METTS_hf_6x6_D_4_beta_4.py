...
file_name5 = f"sz_basis_sample_5_observables_from_METTS_Hubbard_hf_target_beta_4.0_shape_rectangle_Nx_6_Ny_6_boundary_finite_purification_True_fixed_bd_0.0_target_beta_4.000_optimal_one-step_Ds_4_U_8.00_MU_UP_0.00000_MU_DN_0.00000_T_UP_1.00_T_DN_1.00_Z2.txt"
...
ax[0].plot(sample_1_energy[0:nsm], label=r'sample 1, D=4')
ax[0].plot(sample_2_energy[0:nsm], label=r'sample 2, D=4')
ax[0].plot(sample_3_energy[0:nsm], label=r'sample 3, D=4')
ax[0].plot(sample_4_energy[0:nsm], label=r'sample 4, D=4')
ax[0].plot(sample_5_energy[0:nsm], label=r'sample 5, D=4')
ax[0].plot(avg_energy, 'o-',label=r'average D=4')
ax[0].set_ylabel(r'$E$')
ax[0].set_title(r'Half-filling $6\times 6 \quad \beta = 4$')


# Plot the double occupancy data
ax[1].plot(sample_1_do[0:nsm], label=r'sample 1, D=4')
ax[1].plot(sample_2_do[0:nsm], label=r'sample 2, D=4')
ax[1].plot(sample_3_do[0:nsm], label=r'sample 3, D=4')
ax[1].plot(sample_4_do[0:nsm], label=r'sample 4, D=4')
ax[1].plot(sample_5_do[0:nsm], label=r'sample 5, D=4')
ax[1].plot(avg_do, 'o-',label=r'avg D=4')
